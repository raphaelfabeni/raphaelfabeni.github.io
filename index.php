...
<body id="hold" class="default">
    ...
    <main role="main" class="main container main-index">
        ...
        <ul class="social">
            ...
            <li>
                <a id="codepen" class="codepen" target="_blank" href="http://codepen.io/raphaelfabeni/" data-link="CodePen">
    ...
    <button id="color" class="btn" data-link="Color">I don't like this color.</button>
